...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'birthdate', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'phones', 'createdAt', 'updatedAt'];
        }
